...
edges = {
    "root": ["BBB{}".format(i) for i in range(30)],
    "BBB1": ["CCC{}".format(i) for i in range(10)],
    "CCC1": ["DDD{}".format(i) for i in range(10)],
}
...
def angleCo(x, y, xm):
    """
    get a point x,y from a circle-tree
    :param x: x in raw tree
    :param y: y in raw tree
    :param xm: width of all tree
    :return: new x,y in circle
    """
...
def drawt(root, circle:bool = False):
    """
    draw points
    :param root: tree root
    :param circle: whether to draw a circle True->draw a circle
    :return:
    """
    x = root.x
    y = root.y
